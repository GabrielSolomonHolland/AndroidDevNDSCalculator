...
public class Case7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner woodSelect = (Spinner)findViewById(R.id.c7woodSelect);
        ...
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c7deltaSpinner);
    ...
    public void setSpinner2(View v)
    {
        ...
        Log.i("log", "\nEntered setSpinner2");
        Spinner woodSelect = (Spinner)findViewById(R.id.c7woodSelect);
        Spinner spinner2 = (Spinner)findViewById(R.id.c7spinner);
    ...
    public void calculateCase1(View v)
    {
        ...
        float rVMax,mMax,mx,i_req,i_max, deltaa ; //this is what we're calculating
        float p,l,x,a,b, deltaMax, e; //what we're using
        EditText wET =(EditText)findViewById(R.id.c7wValue);
        EditText lET =(EditText)findViewById(R.id.c7LValue);
        EditText xET =(EditText)findViewById(R.id.c7xValue);
        EditText aET =(EditText)findViewById(R.id.c7aValue);
        EditText bET =(EditText)findViewById(R.id.c7bValue);
        //EditText deltaMaxET = (EditText)findViewById((R.id.deltaMaxET));
        TextView resultTV1 = (TextView)findViewById(R.id.c7results1);
        TextView resultTV2 = (TextView)findViewById(R.id.c7results2);
        Spinner woodSelect = (Spinner)findViewById(R.id.c7woodSelect);
        Spinner gradeSelect = (Spinner)findViewById(R.id.c7spinner);
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c7deltaSpinner);
        ...
        try
        {
            ...
            try{
                ...
                //float rVMax,mMax,mx,deltax1, deltax2,i_required, deltaa ; //this is what we're calculating

                Log.i("log","starting initial calculations");
                rVMax = p;
                mMax = p*b;
                Log.i("log","rvmax, mmax complete");
                i_max = (((p*b*b)/(6*e*deltaMax))*((3*l)-b));

                //set outputs
                String output1 = "R=V(max): " + rVMax +
                        "\nM max (at fixed end): " + mMax +
                        "\ni max (at free end):\n" + i_max;
            ...
            try{
                ...
                mx = (p*(x-a));
                    ...
                    if(x<a) {
                        condition = "(x<a)";
                        i_req = (((p*b*b)/(6*e*deltaMax))*(3*l)-(3*x)-(b));
                    }
                    else{
                        condition="(x>a)";
                        i_req = (((p*(l-x)*(l-x))/(6*e*deltaMax))*((3*b-l+x)));
                    }
