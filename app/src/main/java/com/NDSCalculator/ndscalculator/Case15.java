...
public class Case15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner woodSelect = (Spinner)findViewById(R.id.c15woodSelect);
        ...
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c15deltaSpinner);
    ...
    public void setSpinner2(View v)
    {
        ...
        Log.i("log", "\nEntered setSpinner2");
        Spinner woodSelect = (Spinner)findViewById(R.id.c15woodSelect);
        Spinner spinner2 = (Spinner)findViewById(R.id.c15Spanner);
    ...
    public void calculateCase1(View v)
    {
        ...
        EditText wET =(EditText)findViewById(R.id.c15wValue);
        EditText lET =(EditText)findViewById(R.id.c15LValue);
        EditText xET =(EditText)findViewById(R.id.c15xValue);
        //EditText deltaMaxET = (EditText)findViewById((R.id.deltaMaxET));
        TextView resultTV1 = (TextView)findViewById(R.id.c15results1);
        TextView resultTV2 = (TextView)findViewById(R.id.c15results2);
        Spinner woodSelect = (Spinner)findViewById(R.id.c15woodSelect);
        Spinner gradeSelect = (Spinner)findViewById(R.id.c15Spanner);
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c15deltaSpinner);
