...
public class Case13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner woodSelect = (Spinner)findViewById(R.id.c13woodSelect);
        ...
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c13deltaSpinner);
    ...
    public void setSpinner2(View v)
    {
        ...
        Log.i("log", "\nEntered setSpinner2");
        Spinner woodSelect = (Spinner)findViewById(R.id.c13woodSelect);
        Spinner spinner2 = (Spinner)findViewById(R.id.c13Spinner);
    ...
    public void calculateCase1(View v)
    {
        ...
        EditText wET =(EditText)findViewById(R.id.c13wValue);
        EditText lET =(EditText)findViewById(R.id.c13LValue);
        EditText xET =(EditText)findViewById(R.id.c13xValue);
        //EditText deltaMaxET = (EditText)findViewById((R.id.deltaMaxET));
        TextView resultTV1 = (TextView)findViewById(R.id.c13results1);
        TextView resultTV2 = (TextView)findViewById(R.id.c13results2);
        Spinner woodSelect = (Spinner)findViewById(R.id.c13woodSelect);
        Spinner gradeSelect = (Spinner)findViewById(R.id.c13Spinner);
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c13deltaSpinner);
