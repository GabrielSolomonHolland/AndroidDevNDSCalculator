...
public class Case12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner woodSelect = (Spinner)findViewById(R.id.c12woodSelect);
        ...
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c12deltaSpinner);
    ...
    public void setSpinner2(View v)
    {
        ...
        Log.i("log", "\nEntered setSpinner2");
        Spinner woodSelect = (Spinner)findViewById(R.id.c12woodSelect);
        Spinner spinner2 = (Spinner)findViewById(R.id.c12Spinner);
    ...
    public void calculateCase1(View v)
    {
        ...
        EditText wET =(EditText)findViewById(R.id.c12wValue);
        EditText lET =(EditText)findViewById(R.id.c12LValue);
        EditText xET =(EditText)findViewById(R.id.c12xValue);
        //EditText deltaMaxET = (EditText)findViewById((R.id.deltaMaxET));
        TextView resultTV1 = (TextView)findViewById(R.id.c12results1);
        TextView resultTV2 = (TextView)findViewById(R.id.c12results2);
        Spinner woodSelect = (Spinner)findViewById(R.id.c12woodSelect);
        Spinner gradeSelect = (Spinner)findViewById(R.id.c12Spinner);
        Spinner deltaMaxSpinner = (Spinner)findViewById(R.id.c12deltaSpinner);
